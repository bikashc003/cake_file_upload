...
class FileUploadComponent extends Component {
     ...
     */
    private function thumbnail($inputFileName, $thumb_size = 'small', $width = 46, $height = 60, $maintainAspectRatio = false){
    ...
    public function removeFile($file_name, $file_path = null){
        ...
        $thumbsDir = $this->_config['defaultThumb'];

        return $this->FileUpload->removeFile($file_name, $file_path, $thumbsDir);
    }
